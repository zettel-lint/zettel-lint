---
created: 2021-11-06T22:47:29.958Z
modified: 2021-11-06T22:47:29.958Z
title: References
---
...
* (G) Task sort options: ~~By Project (i.e. filename, or by + annotations)~~, ~~by due date~~, ~~by start date~~, ~~by priority~~, ~~alphabetically~~, by context (@ symbols), by List (if multiple `## Tasks` per file) => [tasks][tasks]
